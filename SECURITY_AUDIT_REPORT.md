...
================================================================================
  ...
  Snippet:  apex_REDACTED_rotated_on_2026-05-13
  ...
  Category: Database Connection String
  Snippet:  const connectionString = process.env.DATABASE_URL || 'postgresql://apex:REDACTED@localhost:5433/apex
  Action:   Move connection strings to environment variables. Never commit credentials in URLs.
...
3.  SOURCE CODE -- HARDCODED DB FALLBACKS  [CRITICAL]
    ...
    Finding: process.env.DATABASE_URL || 'postgresql://apex:REDACTED@...'
